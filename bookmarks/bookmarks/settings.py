...
SECRET_KEY = "django-insecure-7c8j-i^u4c13pa1@p2avx0z0ub3!-*u9=6+i9irl+7ijzw%gm)"
...
SOCIAL_AUTH_PIPELINE = [
    ...
    'account.authentication.create_profile', # Custom pipeline step to create Profile in DB
...
# Overrides get_absolute_url method of these models to provided lambda
